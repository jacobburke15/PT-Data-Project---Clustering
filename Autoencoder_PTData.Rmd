...
## removing the last two columns and the first index column
...
x_train <- output <- matrix(unlist(x_train), ncol = 20, byrow = F)
x_test <- output <- matrix(unlist(x_test), ncol = 20, byrow = F)
...
opt_clusters <- kmeans(x_test_encoded, 9)
